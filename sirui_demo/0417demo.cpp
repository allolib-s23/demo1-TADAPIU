...
public:
  ...
  void onProcess(AudioIOData &io) override
  {
    ...
    mOsc11.freq(11*getInternalParameterValue("frequency"));
    mOsc13.freq(13*getInternalParameterValue("frequency"));
    mOsc15.freq(15*getInternalParameterValue("frequency"));
    ...
    while (io())
    {
      ...
      float s1 = mSaw1() * (1.0/2.0) * mAmpEnv() * getInternalParameterValue("amplitude")
