...
public:
  ...
  void playSequenceB(float offset = 1.0)
  {
    ...
    playNote(C4 * offset, 1, 0.5, 0.2);
    playNote(C4 * offset, 2, 0.5, 0.3);
    playNote(D4 * offset, 2.67, 0.2, 0.4);
    playNote(E4 * offset, 3, 0.5, 0.5);

    playNote(E4 * offset, 4, 0.5, 0.2);
    playNote(D4 * offset, 4.67, 0.5, 0.3);
    playNote(E4 * offset, 5, 0.5, 0.4);
    playNote(F4 * offset, 5.67, 0.2, 0.5);
    playNote(G4 * offset, 6, 1, 0.5);

    playNote(C5 * offset, 8, 0.5, 0.2);
    playNote(C5 * offset, 8.67, 0.5, 0.3);
